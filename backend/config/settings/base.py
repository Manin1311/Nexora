...
SIMPLE_JWT = {
    ...
    'UPDATE_LAST_LOGIN': False,  # Disabled: was writing to DB on every token use, causing per-request overhead
    'ALGORITHM': 'HS256',
...
# Google OAuth
GOOGLE_CLIENT_ID = os.getenv('GOOGLE_CLIENT_ID', '677409406492-44in3v5m8b3ns1hg8dt66giul3r7nji7.apps.googleusercontent.com')
