...
const FEATURES = [
  { icon: Code2,        title: 'AI GitHub Reviews',       desc: 'Connect your GitHub profile to scan your public repositories in under 1.5 seconds. Evaluates language ratios, tests coverage, repository complexity, and commit frequency to generate a detailed Code Health Score.', link: '/codereview', badge: 'Fast Scanner', accent: '#6366f1' },
  { icon: Zap,          title: 'Custom AI Learning Roadmaps', desc: 'Analyzes weak areas in your profile and Connected GitHub metrics to generate a custom multi-week learning path generated by AI (Groq LLaMA 3 / Gemini).', link: '/roadmap',    badge: 'AI-Generated',   accent: '#d946ef' },
  { icon: BookOpen,     title: 'Interactive Academy & Graded Quizzes', desc: 'Tapping any roadmap task opens a dedicated tutorial course module with system architecture diagrams and code blocks. Passing a 5-question graded quiz completes the topic.', link: '/roadmap',    badge: 'Graded Quizzes', accent: '#06b6d4' },
  { icon: Brain,        title: 'AI Mock Interview Lab',   desc: 'Simulates real-time interactive technical or HR interviews (FAANG SWE, Frontend, DevOps, Product, etc.). Reviews chat logs, generates detailed feedback lists, and awards XP.', link: '/interview',  badge: 'Interactive',    accent: '#10b981' },
  { icon: BarChart2,    title: 'Skill Analytics & Developer Rank', desc: 'Tracks your journey from Explorer → Builder → Creator → Architect → Legend. Log daily activities, XP charts, and monitor competencies.', link: '/progress',   badge: 'Immersive Stats', accent: '#f59e0b' },
  { icon: Trophy,       title: 'Verified Competency Certifications', desc: 'Complete learning modules to earn downloadable Subject Competency Certificates with a unique platform-verifiable certificate ID (e.g. NXR-E3A5B876).', link: '/progress',   badge: 'Verifiable PDF', accent: '#f43f5e' },
]

const STEPS = [
  { num: '01', title: 'Connect GitHub', desc: 'Link your public repositories in a single secure click.' },
  { num: '02', title: 'AI Profile Scanning', desc: 'Parallel workers scan code structures, commits, and tests in under 1.5s.' },
  { num: '03', title: 'Diagnose Skill Gaps', desc: 'Pinpoint weak areas in system design, backend, frontend, or algorithms.' },
  { num: '04', title: 'Generate Custom Syllabus', desc: 'Receive a personalized, week-by-week learning roadmap.' },
  { num: '05', title: 'Succeed in Academy & Quizzes', desc: 'Study interactive modules and pass graded quizzes to advance.' },
  { num: '06', title: 'Mock Interview Prep', desc: 'Train inside conversational interview labs matching FAANG rubrics.' },
  { num: '07', title: 'Earn Competency Certificates', desc: 'Download verifiable credentials and rank up to Legend.' },
]
    ...
    <section className="section" style={{ position: 'relative', zIndex: 1, overflow: 'hidden' }}>
      <div style={{ maxWidth: '100vw', overflow: 'hidden' }}>
        <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once:true }}
          ...
          <h2 style={{ fontSize:'clamp(28px,4vw,42px)', fontWeight:800, color:'var(--text-heading)', letterSpacing:'-0.02em', fontFamily: 'var(--font-display)' }}>
            ...
            {[...TESTIMONIALS, ...TESTIMONIALS, ...TESTIMONIALS, ...TESTIMONIALS].map((t, idx) => (
              <div key={idx} style={{ flexShrink: 0, width: '360px', background: 'var(--glass-bg)', border: '1px solid var(--glass-border)', borderRadius: '20px', padding: '32px', boxShadow: 'var(--glass-shadow)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', whiteSpace: 'normal' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, borderTop: '1px solid var(--glass-border)', paddingTop: '16px' }}>
                  <Avatar name={t.name} rank={t.rank} size="sm" />
                  <div>
