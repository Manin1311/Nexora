...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (window.google) {
      google.accounts.id.initialize({
        client_id: import.meta.env.VITE_GOOGLE_CLIENT_ID || '677409406492-44in3v5m8b3ns1hg8dt66giul3r7nji7.apps.googleusercontent.com',
  ...
  const handleGoogleCredentialResponse = async (response) => {
    ...
    try {
      ...
      const redirectTo = sessionStorage.getItem('nexora_redirect_after_login') || '/challenges'
    ...
    <div style={S.container}>
      ...
      >
        ...
        <div style={S.card}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 800, color: 'var(--text-heading)', marginBottom: 6 }}>Welcome back</h1>
          <p style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 28 }}>Sign in to continue your journey</p>
          ...
          <p style={{ marginTop: 14, textAlign: 'center', fontSize: 11.5, color: 'var(--text-muted)', lineHeight: 1.4 }}>
            By signing in, you agree to our{' '}
            <Link to="/terms" target="_blank" style={{ color: 'var(--text-muted)', textDecoration: 'underline' }}>
              Terms and Conditions
            </Link>{' '}
            and{' '}
            <Link to="/privacy" target="_blank" style={{ color: 'var(--text-muted)', textDecoration: 'underline' }}>
              Privacy Policy
            </Link>
          </p>
        </div>
